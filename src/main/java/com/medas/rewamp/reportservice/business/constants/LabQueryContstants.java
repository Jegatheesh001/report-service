...
public interface LabQueryContstants {
	...
	" 	where test_results_abnormal.lis_test_code=:lisTestCode ";
	...
	String getMappedResultsetGender = "select sex from test_alt_resultset where normal_id = :referenceId limit 1";
